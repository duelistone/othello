...
#define HELPER8(s, n) {for (taken = (1 << (n)) - 1; taken < 1 << (s); taken = snoob(taken)) {uint64_t black = 0; do {RowBoard<(s)> rb(taken, black); rb.set_stable(); black = (black - taken) & taken;} while (black);}}
...
#define MAX_PENULTIMATE_DEPTH_TIME 20
#define STABILITY 1
#define IID 1
#define USE_HASH_IN_ENDGAME_ALPHABETA 1
#define NEW_WZH 1
#define ENDGAME_PRESEARCH_DEPTH 6
#define DEEP_ENDGAME_PRESEARCH_DEPTH 0
#define ENDGAME_START 40
#define DEEP_ENDGAME_START 50
#define MAX_DEPTH 17
